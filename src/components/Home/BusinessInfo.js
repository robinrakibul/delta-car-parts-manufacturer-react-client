    ...
    return (
        <div id='businessInfo'>
            ...
            <div className='grid grid-flow-row grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 m-5 mb-10'>
                <div className="card w-3/4 h-96 mx-auto bg-base-100 shadow-xl image-full">
                    ...
                    <div className="card-body items-center">
                        ...
                        <h2 className="card-title">We Served 100k+ Customers!</h2>
                ...
                <div className="card w-3/4 h-96 mx-auto bg-base-100 shadow-xl image-full">
                    ...
                    <div className="card-body items-center">
                        ...
                        <h2 className="card-title">50+ Car Parts</h2>
