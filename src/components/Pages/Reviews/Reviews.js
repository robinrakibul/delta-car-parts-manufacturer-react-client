...
const Reviews = () => {
    ...
    useEffect(() => {
        fetch('https://manufacturer-node-server.onrender.com/reviews')
            .then(res => res.json())
    ...
    return (
        <>
            ...
            <div className='grid grid-flow-row grid-cols-1 ml-5 mr-5 md:grid-cols-2 lg:grid-cols-3 gap-2 justify-center'>
                {
                    reviews.map(review => (
