...
const Login = () => {
    ...
    if (loading || loading2 || sending) {
        // Spinner
        return <div>
            <svg role="status" className="inline mt-52 mb-52 mr-2 w-10 h-10 text-black animate-spin fill-red-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
